...
-- Large boat markers need a matching server-side validation radius; otherwise players can see/use
-- the marker but be rejected by the server because the Tug/ped position is slightly offset.
Config.RouteValidationDistance = 55.0
...
Config.Markers = {
    ...
    returnTug = { scale = vector3(40.0, 40.0, 3.0), interactDistance = 40.0, color = { r = 255, g = 60, b = 60, a = 160 } },
    load = { scale = vector3(45.0, 45.0, 3.0), interactDistance = 45.0, color = { r = 60, g = 180, b = 255, a = 160 } },
    deliver = { scale = vector3(45.0, 45.0, 3.0), interactDistance = 45.0, color = { r = 40, g = 220, b = 90, a = 160 } }
}
...
Config.Text = {
    ...
    tooFar = 'از محدوده مارکر شغل دور هستید.',
